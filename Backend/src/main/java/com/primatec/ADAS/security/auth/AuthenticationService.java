...
import com.primatec.ADAS.security.config.JwtService;
import com.primatec.ADAS.security.token.Token;
import com.primatec.ADAS.security.token.TokenRepository;
import com.primatec.ADAS.security.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    var jwtToken = jwtService.generateTokenWithUserId(user,user);
